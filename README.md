...
|------------------|-----------------|-------|------------|-------|--------|
| process_creation | Microsoft-Windows-Sysmon/Operational:1<br>Security:4688 | 2740 | 58.17% | 2740 | sysmon |
| registry_set | Microsoft-Windows-Sysmon/Operational:13 | 434 | 9.21% | 434 | sysmon |
| security | Security | 257 | 5.46% | 257 | default |
| file_event | Microsoft-Windows-Sysmon/Operational:11 | 215 | 4.56% | 215 | sysmon |
| ps_script | Microsoft-Windows-PowerShell/Operational,PowerShellCore/Operational:4104 | 187 | 3.97% | 187 | default |
| image_load | Microsoft-Windows-Sysmon/Operational:7 | 126 | 2.68% | 126 | sysmon |
| network_connection | Microsoft-Windows-Sysmon/Operational:3<br>Security:5156 | 104 | 2.21% | 104 | sysmon |
| system | System | 98 | 2.08% | 98 | default |
| registry_event | Microsoft-Windows-Sysmon/Operational:12,13,14<br>Security:4657 | 82 | 1.74% | 82 | sysmon |
| sysmon | Microsoft-Windows-Sysmon/Operational | 62 | 1.32% | 62 | sysmon |
| ps_module | Microsoft-Windows-PowerShell/Operational,PowerShellCore/Operational:4103 | 36 | 0.76% | 36 | sysmon |
...
| registry_add | Microsoft-Windows-Sysmon/Operational:12<br>Security:4657 | 20 | 0.42% | 20 | sysmon |
| pipe_created | Microsoft-Windows-Sysmon/Operational:17,18 | 20 | 0.42% | 20 | sysmon |
...
|---------|-------|-------|------------|
| 4688 | Process created | 1329 | 78.08% |
| 4657 | Registry value modified | 268 | 15.75% |
| 5156 | Firewall allowed a connection | 40 | 2.35% |
