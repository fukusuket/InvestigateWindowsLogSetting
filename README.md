...
|------------------|-----------------|-------|------------|-------|--------|
| process_creation | Microsoft-Windows-Sysmon/Operational:1<br>Security:4688 | 2683 | 58.14% | 2683 | sysmon |
...
|---------|-------|-------|------------|
| 4688 | Process created | 1301 | 77.81% |
| 4657 | Registry value modified | 266 | 15.91% |
